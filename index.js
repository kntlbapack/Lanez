...
/////////////////
const BotName = 'LAN BOT☄'; 
const instagram = 'https://instagram.com/Gada ig.id'; 
const telegram = 'https://t.me/Dante'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/ihh wibu_id';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by LAN HENGKER.id')
